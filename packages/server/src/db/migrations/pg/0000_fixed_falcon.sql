...
CREATE TABLE "games" (
	...
	"spectator_chat_enabled" boolean NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX "auth_sessions_token_idx" ON "auth_sessions" USING btree ("session_token");--> statement-breakpoint
...
CREATE UNIQUE INDEX "guest_sessions_token_idx" ON "guest_sessions" USING btree ("session_token");--> statement-breakpoint
